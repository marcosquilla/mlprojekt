...
def Car_train():
    dm = CarDataModule(shuffle=True, batch_size=16, num_workers=int(os.cpu_count()/2))
    ...
    model = BC_Car(hidden_layers=(50*in_size, int(25*in_size+15*out_size), 30*out_size), in_out=(in_size, out_size))
    return model, dm
